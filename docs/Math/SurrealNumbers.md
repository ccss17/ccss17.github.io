...
- 최초의 초현실수 $0 = \{|\}$, 즉 day zero 에 태어난 초현실수 이후에 day one 에 태어난 초현실수는 
    ...
    $$ -3, -2, - \dfrac{3}{2}, -1, - \dfrac{3}{4}, - \dfrac{1}{2}, - \dfrac{1}{4}, 0 , \dfrac{1}{4}, \dfrac{1}{2}, \dfrac{3}{4}, 1, \dfrac{3}{2}, 2 $$
...
- 증명
    ...
    3. $\{x_i|\}$ 에 대하여 $j>n$ 라면 이것은 day $m$ 에 존재했다. 
    ...
    [정리 5](#c076cc283) 에 의하여 $\{|x_1\} < x_1$ 이고 $x_1$ 은 day $m$ 에서 가장 작은 초현실수이므로 day $m+1$ 에서 가장 작은 초현실수는 $\{|x_1\}$ 이다. 

    [정리 5](#c076cc283) 에 의하여 $x_n < \{x_n|\}$ 이고 $x_n$ 은 day $m$ 에서 가장 큰 초현실수이므로 day $m+1$ 에서 가장 큰 초현실수는 $\{x_n|\}$ 이다. ▲ 
