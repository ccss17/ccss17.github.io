...
- 지금까지 정의한 표기 규칙에 의하여 well-formedness 조건 $(1.1)$ 을 다음과 같이 더욱 간략하게 나타낼 수 있다.
    ...
    [$\leq$ 의 정의](#f383291d7)를 정의하는 $(1.4)$ 도 다음과 같이 나타낼 수 있다.
...
- 증명 
    ...
    $(2.26)$ 을 귀납법으로 증명해보자(*$A_L \cup A_R$ 에 대하여 참임을 가정하고 $A$ 에 대하여 참이라는 것을 보이는 것이다*). $A= \varnothing$ 일 경우 자명하게 참이다. $(2.26)$ 은 [$\leq$ 의 정의](#f383291d7) 에 의하여 
...
- 증명 
    ...
    를 증명하는 것이다. 이는 [$\leq$ 의 정의](#f383291d7) 에 의하여 다음을 증명하는 것과 같다. 
