...
# <a name="선형방정식" href="#선형방정식">선형방정식</a>

---

# <a name="선형대수학 메모 " href="#선형대수학 메모 ">선형대수학 메모 </a>

# <a name="선형대수학에서의 선형방정식" href="#선형대수학에서의 선형방정식">선형대수학에서의 선형방정식</a>
...
## <a name="선형방정식계 " href="#선형방정식계 ">선형방정식계 </a>
...
### <a name="행렬표기법 " href="#행렬표기법 ">행렬표기법 </a>
...
### <a name="선형계 풀이법  " href="#선형계 풀이법  ">선형계 풀이법  </a>
...
### <a name="해의 존재성과 유일성" href="#해의 존재성과 유일성">해의 존재성과 유일성</a>
...
## <a name="행 축약과 사다리꼴 " href="#행 축약과 사다리꼴 ">행 축약과 사다리꼴 </a>
...
### <a name="선형계의 해 " href="#선형계의 해 ">선형계의 해 </a>
...
### <a name="해집합의 매개변수 표현" href="#해집합의 매개변수 표현">해집합의 매개변수 표현</a>
...
## <a name="벡터방정식" href="#벡터방정식">벡터방정식</a>
...
### <a name="$\mathbb{R}^2$에서의 벡터" href="#$\mathbb{R}^2$에서의 벡터">$\mathbb{R}^2$에서의 벡터</a>
...
### <a name="$\mathbb{R}^3$에서의 벡터" href="#$\mathbb{R}^3$에서의 벡터">$\mathbb{R}^3$에서의 벡터</a>
...
### <a name="$\mathbb{R}^n$에서의 벡터" href="#$\mathbb{R}^n$에서의 벡터">$\mathbb{R}^n$에서의 벡터</a>
...
### <a name="일차결합(linear combination)" href="#일차결합(linear combination)">일차결합(linear combination)</a>
...
### <a name="벡터방정식 (vector equation)" href="#벡터방정식 (vector equation)">벡터방정식 (vector equation)</a>
...
## <a name="행렬방정식 $Ax = b$" href="#행렬방정식 $Ax = b$">행렬방정식 $Ax = b$</a>
...
### <a name="해의 존재성" href="#해의 존재성">해의 존재성</a>
...
### <a name="행렬과 벡터 곱 $Ax$ 의 성질" href="#행렬과 벡터 곱 $Ax$ 의 성질">행렬과 벡터 곱 $Ax$ 의 성질</a>
...
## <a name="선형계의 해집합 " href="#선형계의 해집합 ">선형계의 해집합 </a>

### <a name="동차선형계 (homogeneous)" href="#동차선형계 (homogeneous)">동차선형계 (homogeneous)</a>
...
### <a name="매개변수 벡터 형식" href="#매개변수 벡터 형식">매개변수 벡터 형식</a>
...
### <a name="비동차계의 해집합" href="#비동차계의 해집합">비동차계의 해집합</a>
...
## <a name="일차 독립 " href="#일차 독립 ">일차 독립 </a>
...
### <a name="두 개 이상의 벡터로 이루어진 집합의 일차 독립" href="#두 개 이상의 벡터로 이루어진 집합의 일차 독립">두 개 이상의 벡터로 이루어진 집합의 일차 독립</a>
...
## <a name="선형변환(linear transformation) 입문 " href="#선형변환(linear transformation) 입문 ">선형변환(linear transformation) 입문 </a>
...
## <a name="선형변환 행렬" href="#선형변환 행렬">선형변환 행렬</a>
...
### <a name="존재성과 유일성 문제 " href="#존재성과 유일성 문제 ">존재성과 유일성 문제 </a>
