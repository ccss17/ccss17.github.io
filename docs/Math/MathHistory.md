...
- 다음 그림이 평행선 공리를 보여줍니다. 두 직선이 있을 때 다른 한 직선이 두 개의 직선과 만납니다. 그런데 두 내각 $\alpha,\beta) 를 더한 것이 ![](https://latex.codecogs.com/svg.latex?180\degree) 보다 작습니다. 그러면 두 직선을 길게 늘리면 두 직선은 두 내각 $\alpha,\beta) 이 있는 방향에서 만납니다. 
...
:   [『기하학원론(가): 평면기하(제1-4권)』, 유클리드](https://book.naver.com/bookdb/book_detail.nhn?bid=60711)
