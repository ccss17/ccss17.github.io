...
우리는 **[ProgrammerBase](https://ccss17.github.io/ProgrammerBase)** 에서 [빌조이의 Why the future doesn't need us 를 간추려서](https://ccss17.github.io/ProgrammerBase/blob/master/future.md#why-the-future-doesnt-need-us) 살펴보았었습니다. 이때 기술적 특이점도 살펴보았는데, 기술적 특이점이 말하는 초지능의 시작이 **강인공지능** 의 탄생입니다. 인공지능은 다음과 같이 약인공지능과 강인공지능으로 분류할 수 있습니다.
...
[HW-1.md](HW-1/README.md) 파일의 지시를 따르는 것이 과제입니다. (발표를 하며 설명을 할 수 있어야 합니다)
