...
- 표준편차(standard deviation) : 어떤 대상의 산포도를 나타내는 수치로써 
  ...
  - 편차란 각 자료에 대한 산포도를 보여주지만 모두 더해서 전체 대상에 대한 산포도를 관찰하려 하면 $0$ 이 되버려서 산포도를 구할 수 없었다.
    ...
    하지만 분산은 편차에 대한 제곱을 취하였기 때문에 산포도가 불필요하게 커져버렸다. 

    따라서 표준편차를 도입하여 분산에 제곱근을 취하여 과하게 커져버린 산포도를 원래의 양으로 되돌려주는 것이다. 
  ...
  - 예시 
    ...
    를 얻고 회사 $B$ 의 분산에 제곱근을 취하여 회사 $B$ 의 표준편차

    $$ \therefore  \sigma _{B} = \sqrt[]{V_B} =  \sqrt[]{208600} \approx  456 $$

    를 얻을 수 있다. ■ 

    - 분산으로 각 대상에 대한 산포도를 관찰하려 했을 때는 그 값이 너무 컸다. 회사 $A$ 의 분산과 회사 $B$ 의 분산은 

      $$ V_A =  5753600, V_B = 208600 $$

      이었다. 하지만 회사 $A$ 의 표준편차와 회사 $B$ 의 표준편차는 

      $$ \sigma _{A} \approx  2398, \sigma _{B} \approx  456 $$

      이다. 이로써 회사 $A$ 연봉의 산포도가 회사 $B$ 연봉의 산포도보다 높다는 것을 쉽게 알 수 있다. 
