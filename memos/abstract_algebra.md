...
# <a name="<a name=\"추상대수학 메모 \" href=\"#추상대수학 메모 \">추상대수학 메모 </a>" href="#<a name=\"추상대수학 메모 \" href=\"#추상대수학 메모 \">추상대수학 메모 </a>"><a name=\"추상대수학 메모 \" href=\"#추상대수학 메모 \">추상대수학 메모 </a></a>
...
## <a name="<a name=\"추상대수학\" href=\"#추상대수학\">추상대수학</a>" href="#<a name=\"추상대수학\" href=\"#추상대수학\">추상대수학</a>"><a name=\"추상대수학\" href=\"#추상대수학\">추상대수학</a></a>
...
- 대표적으로 실수 집합 $\R$ 에는 덧셈($+$), 곱셈($\times$) 이 잘 정의되어 있고 덧셈, 곱셈에 대한 결합법칙, 교환법칙, 분배법칙이 성립하며, 항등원과 역원이 조화롭게 성립하여 대수적 구조를 만들어내었다. 

  - 초중고등학교 수학에서는 이와 같은 실수 대수 구조를 정의하지 않고 단지 직관적으로 덧셈과 뺄셈, 곱셈 등을 사용했지만 지금까지 두 실수를 자유롭게 사칙연산을 할 수 있었던 이유가 실수 집합 $\R$ 의 대수 구조 때문이었다. 
...
## <a name="<a name=\"연산의 추상화\" href=\"#연산의 추상화\">연산의 추상화</a>" href="#<a name=\"연산의 추상화\" href=\"#연산의 추상화\">연산의 추상화</a>"><a name=\"연산의 추상화\" href=\"#연산의 추상화\">연산의 추상화</a></a>
...
- 예시 
  ...
  실수 집합 $\R$ 위에 정의된 사칙 연산은 다음과 같다. 

  - 덧셈은 다음과 같이 정의된 이항연산, 즉 함수이다.

    $$+: \R \times \R \to \R, (r, s) \mapsto r + s$$
  ...
  - 곱셈은 다음과 같이 정의된 이항연산, 즉 함수이다.
    ...
    $$\times : \R \times \R \to \R, (r, s) \mapsto r \times  s$$

  - 나눗셈은 다음과 같이 정의된 함수이지만 $0$ 으로 나누기가 정의되어 있지 않기에 이항연산은 아니다.

    $$\div  : \R \times \R ^{*} \to \R, (r, s) \mapsto r \div   s$$

    또는

    $$\div  : \R \times \R \text{\textbackslash} \{0\} \to \R, (r, s) \mapsto r \div   s$$
...
# <a name="<a name=\"여러가지 대수구조\" href=\"#여러가지 대수구조\">여러가지 대수구조</a>" href="#<a name=\"여러가지 대수구조\" href=\"#여러가지 대수구조\">여러가지 대수구조</a>"><a name=\"여러가지 대수구조\" href=\"#여러가지 대수구조\">여러가지 대수구조</a></a>

## <a name="<a name=\"군론\" href=\"#군론\">군론</a>" href="#<a name=\"군론\" href=\"#군론\">군론</a>"><a name=\"군론\" href=\"#군론\">군론</a></a>
...
- 예시 
  ...
  정방행렬의 집합 $\R ^{n \times n}$ 은 행렬곱 연산 $\cdot$ 에 대하여 단위행렬 $I_n$ 을 항등원으로 가지므로 $(\R, \cdot)$ 은 모노이드이다. 
...
- 예시 
  ...
  덧셈($+$) 이 정의되어 있는 자연수 집합 $\N$ 은 군을 이루지 못한다.
  ...
  - 그러나 G.2 항등원이 존재하지 않는다. 
    ...
    덧셈($+$) 에 대한 항등원은 $0$ 인데 $0$ 은 자연수 집합 $\N$ 에 속하지 않는다. 
...
## <a name="<a name=\"환론\" href=\"#환론\">환론</a>" href="#<a name=\"환론\" href=\"#환론\">환론</a>"><a name=\"환론\" href=\"#환론\">환론</a></a>
...
## <a name="<a name=\"체론\" href=\"#체론\">체론</a>" href="#<a name=\"체론\" href=\"#체론\">체론</a>"><a name=\"체론\" href=\"#체론\">체론</a></a>
...
- 예시 
  ...
  - 실수체 $\R$ 에서 모든 원소 $r \in \R$ 에 대하여 역원 $\frac{1}{r} \in \R$ 이 존재하므로 모든 원소가 가역원이다.
...
- 좌표평면에서의 위치벡터와 좌표공간에서의 위치벡터의 집합
  ...
  $$ \R  ^{2} = \{(x, y) | x, y \in \R \} ,\R  ^{3} = \{(x, y, z) | x, y, z \in \R \} $$ 
...
# <a name="<a name=\"범주론\" href=\"#범주론\">범주론</a>" href="#<a name=\"범주론\" href=\"#범주론\">범주론</a>"><a name=\"범주론\" href=\"#범주론\">범주론</a></a>
