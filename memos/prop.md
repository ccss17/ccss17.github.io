...
- 합의 법칙 : 사건 $A_1, A_2, \dots, A_n$ 이 동시에 일어나지 않을 때
  ...
  사건 "$A_1$, 또는 $A_2$, 또는 $\dots$ 또는 $A_n$" 이 일어나는 모든 경우의 수는 $\boxed{\displaystyle  \sum_{k=1}^{n}a_k}$ 이다. 
...
- 곱의 법칙 : 사건 $A_1, A_2, \dots, A_n$ 이 연이어 일어날 때
  ...
  사건 $A_1, A_2, \dots, A_n$ 이 연이어 일어나는 모든 경우의 수는 $\boxed{\displaystyle \prod_{k=1}^{n}a_k}$ 이다. 
