...
- $\therefore$ 새로운 지식을 제대로 전달하기 위해서는 그 지식을 도출하기까지 했던 사유과정을 구체적으로 언어로 변환하여 전달해야 한다.
...
- 사람은 감각으로 수용된 실제 세상을 지능을 통해 가공하여 마음 속에 구축한다.
